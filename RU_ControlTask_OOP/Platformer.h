...
public:
    Platformer();
    Platformer(string name, string dev, int relDay, int relMonth, int relYear, int version, double size, double stars, int obstaclesNum, string objective, const string* obstacles, int downloads = 0, int levels = 1);
